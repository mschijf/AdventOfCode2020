...
public class Input {
    ...
    public Input(String fileName) {
        List<String> list = readFile("data/" + fileName);
        list = unwrapLines(list);
        List<List<String>> keyValueStrings = doSplit(list, " ");
        inputList = toListOfHashMaps(keyValueStrings, ":");
    }

    public List<HashMap<String, String>> getInputList() {
        return inputList;
    }
